...
class AgentConfig:
    ...
    require_exact_binding: bool = field(
        default=False,
        metadata=_meta(
            "Require exact model and effort",
            "For supported adapters, require explicit model and effort settings and "
            "matching runtime readback before each prompt. Refuse substitutions, "
            "effort reductions and configured model fallback. Authentication is separate.",
        ),
    )
    provider: str = field(
        default="acp",
