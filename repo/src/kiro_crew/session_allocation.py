...
from kiro_crew.agent_sdk.backends import ACP_BACKENDS_DEDICATED_TASK_SESSIONS
...
class SessionAllocationService:
    ...
    async def open_task_session(
        ...
        *,
        ...
        if owner._cfg.agent.acp_backend in ACP_BACKENDS_DEDICATED_TASK_SESSIONS:
            # These adapters already implement dedicated provider sessions.
            # Keep task leases, model selection and shutdown on that native
            # path instead of bootstrapping an unrelated shared runtime.
