...
class TestConfigWriteProtection:
    ...
    def test_config_json_is_write_protected(self) -> None:
        ...
        assert is_sensitive_write_path(str(fake_home_path() / ".kiro" / "crew" / "config.json"))
        assert is_sensitive_write_path("~/.kirocrew/config.json")
        assert is_sensitive_write_path(str(fake_home_path() / ".kirocrew" / "config.json"))
    ...
    def test_config_local_json_is_write_protected(self) -> None:
        ...
        assert is_sensitive_write_path(
            str(fake_home_path() / ".kiro" / "crew" / "config.local.json")
        )
        assert is_sensitive_write_path("~/.kirocrew/config.local.json")
        assert is_sensitive_write_path(str(fake_home_path() / ".kirocrew" / "config.local.json"))
